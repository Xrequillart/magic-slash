...
export const fr: Record<keyof typeof en, string> = {
  ...
  'plans.access.personalRepo': 'Ce plan est sur un dépôt personnel : vous seul le voyez. Partagez le dépôt avec une organisation pour partager ses plans.',
  'plans.access.shareRepo': 'Partager le dépôt',
