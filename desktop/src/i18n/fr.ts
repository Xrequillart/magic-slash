...
export const fr: Record<keyof typeof en, string> = {
  ...
  'plans.history.hint': 'Qui a modifié la spécification et les liens, et comment',
  ...
  'plans.history.select': 'Sélectionner pour comparer',
  'plans.history.pickHint': 'Sélectionnez une révision pour voir ce qu’elle a changé, ou deux pour les comparer.',
  ...
  'plans.history.diffBetween': 'Entre les deux révisions sélectionnées',
