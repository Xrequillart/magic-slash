...
export const fr: Record<keyof typeof en, string> = {
  ...
  'controlCenter.features': 'Fonctionnalités',
  'controlCenter.splitView': 'Vue divisée',
  ...
  'plans.decisions.decision': 'Décision prise',
  'plans.decisions.reason': 'Pourquoi',
  'plans.decisions.expand': 'Afficher la décision et pourquoi',
  'plans.decisions.collapse': 'Replier cette question',
  'plans.sizing.verdict': 'Verdict',
  'plans.sizing.deliverables': 'Livrables comptés',
  'plans.sizing.splitting': 'Mode de découpage',
  'plans.sizing.justification': 'Justification',
  'plans.specHeader.repository': 'Dépôt',
  'plans.specHeader.tracker': 'Tracker',
  'plans.specHeader.created': 'Créée le',
  'plans.specHeader.status': 'Statut',
  'plans.specHeader.statuses.drafting': 'En rédaction',
  'plans.specHeader.statuses.awaiting': 'En attente de validation',
  'plans.specHeader.statuses.created': 'Tickets créés',
  'plans.specHeader.statuses.abandoned': 'Abandonnée',
  ...
  'plans.access.title': 'Qui peut voir et modifier',
  'plans.access.share': 'Partager',
  'plans.access.invitedHeading': 'Invités',
  'plans.access.inviteNamed': 'Inviter {name}',
  'plans.access.personal': 'Personnel',
  'plans.access.org': 'Toute l’organisation',
  'plans.access.admins': 'Les admins uniquement',
  'plans.access.invited': 'Les personnes invitées',
  'plans.access.personalHint': 'Ce plan n’est visible et modifiable que par vous. L’organisation ne le voit pas, admins compris.',
  'plans.access.personalHintNoOrg': 'Ce plan n’est visible et modifiable que par vous.',
  'plans.access.invitedHintNoOrg': 'Seuls vous et les personnes invitées ici peuvent voir, commenter et modifier ce plan.',
  'plans.access.inviteMenuNoOrg': 'Inviter un membre de vos organisations',
  'plans.access.membersFailedNoOrg': 'Les membres de vos organisations n’ont pas pu être chargés.',
  'plans.access.noOrgToShare': 'Personne n’est disponible pour le partage : vous ne faites partie d’aucune organisation.',
  'plans.access.orgHint': 'Toute l’organisation peut voir et modifier ce plan.',
  ...
  'plans.access.membersFailed': 'Les membres de l’organisation n’ont pas pu être chargés.',
  'plans.access.remove': 'Retirer {name}',
  'plans.access.denied': 'Vous ne pouvez pas changer qui peut modifier ce plan.',
  'plans.access.failed': 'La modification n’a pas pu être enregistrée.',
  'plans.access.readOnly': 'Vous pouvez lire et commenter ce plan, mais pas le modifier.',
  'plans.access.readOnlyAdmins': 'Son auteur en a réservé la modification aux admins de l’organisation.',
  'plans.access.readOnlyInvited': 'Son auteur en a réservé la modification à des personnes invitées.',
  'plans.history.title': 'Historique',
  'plans.history.empty': 'Aucune modification enregistrée pour l’instant.',
  ...
  'plans.history.olderHidden': 'Des révisions plus anciennes existent mais ne sont pas affichées : impossible de la comparer à la précédente.',
  'plans.history.diffFailed': 'Cette comparaison n’a pas pu être calculée.',
  ...
  'agentInfo.runScripts': 'Lancer un script',
  ...
  'prComments.codeCommentCounter': '{current} / {total} commentaires de code',
  ...
  'tasks.detail.comment': 'Commentaire',
  'tasks.detail.edited': 'modifié',
  'tasks.detail.editedOn': 'Modifié le {date}',
  'tasks.detail.emptyComment': 'Ce commentaire n’a pas de texte.',
  'tasks.detail.commentsShowingFirst': 'les {count} premiers affichés',
  'tasks.detail.commentsShowingLast': 'les {count} derniers affichés',
