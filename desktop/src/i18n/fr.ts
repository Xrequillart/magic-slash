...
export const fr: Record<keyof typeof en, string> = {
  ...
  'dashboard.usageEmpty': 'Aucun usage enregistré pour l’instant.',
  'dashboard.usageEmptyHint':
    'Le suivi d’usage est facultatif. Les membres qui l’activent dans les réglages voient un instantané agrégé enregistré à la fin de chaque session.',
  'dashboard.capped':
    'Seules les 5 000 sessions les plus récentes sont prises en compte — les totaux ci-dessous sont partiels et sous-estiment l’activité plus ancienne.',
  'dashboard.totalCost': 'Coût total',
  'dashboard.sessions': 'Sessions',
  'dashboard.linesAdded': 'Lignes ajoutées',
  'dashboard.linesRemoved': 'Lignes supprimées',
  'dashboard.totalDuration': 'Durée totale',
  'dashboard.byMember': 'Par membre',
  'dashboard.unassigned': 'Non attribué',
  'dashboard.sessionCount.one': '{count} session',
  'dashboard.sessionCount.other': '{count} sessions',
