...
export const fr: Record<keyof typeof en, string> = {
  ...
  'dashboard.capped': 'sur les 5 000 sessions les plus récentes',
  'dashboard.unassigned': 'Non attribué',
  'dashboard.awaitingReview': 'PR en attente de revue',
  'dashboard.blocked': 'Bloqué',
  'dashboard.openPR': 'Ouvrir la pull request',
  'dashboard.viewPR': 'Voir la PR',

  // ── Tableau d'équipe : métriques de flux ─────────────────────────────────
  'dashboard.flow.section': 'Flux',
  'dashboard.flow.window7': '7 j',
  'dashboard.flow.window30': '30 j',
  'dashboard.flow.window90': '90 j',
  'dashboard.flow.stage.coding': 'Développement',
  'dashboard.flow.stage.awaitingReview': 'En attente de revue',
  'dashboard.flow.stage.changesRequested': 'Modifications demandées',
  'dashboard.flow.stage.readyToMerge': 'Prêt à merger',
  'dashboard.flow.oldest': 'plus ancien {age}',
  'dashboard.flow.bottleneck': 'C’est ici que ça s’accumule : {stage}',
  'dashboard.flow.pipelineEmpty': 'Aucun travail en cours pour le moment.',
  'dashboard.flow.stalled': 'À débloquer',
  'dashboard.flow.stalledNone': 'Rien ne traîne anormalement.',
  'dashboard.flow.stalledCoding': 'pas encore de PR',
  'dashboard.flow.stalledReadyToMerge': 'approuvée, non mergée',
  'dashboard.flow.stalledMore': '{count} de plus',
  'dashboard.flow.where': 'Où passe le temps',
  'dashboard.flow.segment.reviewWait': 'Attente de revue',
  'dashboard.flow.segment.toMerge': 'De la revue au merge',
  'dashboard.flow.metric.reviewWait': 'Délai avant première revue',
  'dashboard.flow.metric.coding': 'Temps de développement',
  'dashboard.flow.metric.prToMerge': 'De la PR au merge',
  'dashboard.flow.metric.rework': 'Reprises',
  'dashboard.flow.reworkRatio': '{count} sur {total}',
  'dashboard.flow.reworkHint': 'PR ayant demandé des modifications',
  'dashboard.flow.sample': 'n={count}',
  'dashboard.flow.sampleRaw': 'valeurs brutes · {count} pour l’instant',
  'dashboard.flow.noSample': 'pas encore de données',
  'dashboard.flow.throughput': 'Mergées par semaine',
  'dashboard.flow.weekOf': 'Semaine du {date}',
  'dashboard.flow.weekCount.one': '{count} mergée',
  'dashboard.flow.weekCount.other': '{count} mergées',
  'dashboard.flow.weekUnknown': 'au-delà de ce que cette vue peut lire',
  'dashboard.flow.empty': 'Aucune activité de workflow pour l’instant.',
  'dashboard.flow.emptyHint':
    'L’activité est enregistrée automatiquement quand tu lances les skills /magic:* — démarre une tâche, committe, ouvre une PR, et ça se remplit.',
  'dashboard.flow.noTickets': 'Les métriques de flux ont besoin d’identifiants de ticket.',
  'dashboard.flow.noTicketsHint':
    'Démarre les agents depuis un ticket (/magic:start PROJ-123) pour que leurs événements restent corrélables après la fermeture de l’agent.',
  'dashboard.flow.notEnough': 'Pas encore assez de tickets terminés pour mesurer un temps de cycle — il en faut {need}.',
  'dashboard.flow.capped':
    'Limite de lignes atteinte sur cette fenêtre : les semaines les plus anciennes sont coupées, pas vides.',
  'dashboard.flow.inFlight': '{count} encore ouverts, exclus des médianes',
  'dashboard.flow.unattributed': '{count} événements n’ont pu être rattachés à un ticket',
  'dashboard.flow.usage': 'Usage — {cost} sur {count} sessions',
