...
export const en = {
  ...
  // ── Team dashboard ───────────────────────────────────────────────────────
  'dashboard.capped': 'based on the most recent 5,000 sessions',
  'dashboard.unassigned': 'Unassigned',
  'dashboard.awaitingReview': 'PRs awaiting review',
  'dashboard.blocked': 'Blocked',
  'dashboard.openPR': 'Open the pull request',
  'dashboard.viewPR': 'View PR',

  // ── Team dashboard: flow metrics ─────────────────────────────────────────
  'dashboard.flow.section': 'Flow',
  'dashboard.flow.window7': '7d',
  'dashboard.flow.window30': '30d',
  'dashboard.flow.window90': '90d',
  'dashboard.flow.stage.coding': 'Coding',
  'dashboard.flow.stage.awaitingReview': 'Awaiting review',
  'dashboard.flow.stage.changesRequested': 'Changes requested',
  'dashboard.flow.stage.readyToMerge': 'Ready to merge',
  'dashboard.flow.oldest': 'oldest {age}',
  'dashboard.flow.bottleneck': 'Most work is sitting in: {stage}',
  'dashboard.flow.pipelineEmpty': 'No active work right now.',
  'dashboard.flow.stalled': 'Needs a nudge',
  'dashboard.flow.stalledNone': 'Nothing has been sitting too long.',
  'dashboard.flow.stalledCoding': 'no PR yet',
  'dashboard.flow.stalledReadyToMerge': 'approved, not merged',
  'dashboard.flow.stalledMore': '{count} more',
  'dashboard.flow.where': 'Where the time goes',
  'dashboard.flow.segment.reviewWait': 'Waiting for review',
  'dashboard.flow.segment.toMerge': 'Review to merge',
  'dashboard.flow.metric.reviewWait': 'Time to first review',
  'dashboard.flow.metric.coding': 'Coding time',
  'dashboard.flow.metric.prToMerge': 'PR to merge',
  'dashboard.flow.metric.rework': 'Rework',
  'dashboard.flow.reworkRatio': '{count} of {total}',
  'dashboard.flow.reworkHint': 'PRs that needed changes',
  'dashboard.flow.sample': 'n={count}',
  'dashboard.flow.sampleRaw': 'shown raw · {count} so far',
  'dashboard.flow.noSample': 'no data yet',
  'dashboard.flow.throughput': 'Merged per week',
  'dashboard.flow.weekOf': 'Week of {date}',
  'dashboard.flow.weekCount.one': '{count} merged',
  'dashboard.flow.weekCount.other': '{count} merged',
  'dashboard.flow.weekUnknown': 'further back than this view can read',
  'dashboard.flow.empty': 'No workflow activity yet.',
  'dashboard.flow.emptyHint':
    'Activity is recorded automatically as you run the /magic:* skills — start a task, commit, open a PR, and this fills in.',
  'dashboard.flow.noTickets': 'Flow metrics need ticket ids.',
  'dashboard.flow.noTicketsHint':
    'Start agents from a ticket (/magic:start PROJ-123) so their events can be correlated once the agent is closed.',
  'dashboard.flow.notEnough': 'Not enough finished tickets to measure cycle time yet — {need} needed.',
  'dashboard.flow.capped':
    'Hit the row limit for this window, so the oldest weeks are cut off rather than empty.',
  'dashboard.flow.inFlight': '{count} still open, excluded from the medians',
  'dashboard.flow.unattributed': '{count} events could not be tied to a ticket',
  'dashboard.flow.usage': 'Usage — {cost} across {count} sessions',
