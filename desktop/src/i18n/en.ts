...
export const en = {
  ...
  'plans.access.personalRepo': 'This plan is on a personal repository: only you can see it. Share the repository with an organization to share its plans.',
  'plans.access.shareRepo': 'Share the repository',
