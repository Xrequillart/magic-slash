 ...
 * flags are here for.
 *
 * The same component exists in `desktop/src/renderer/components/Flag.tsx`. Ported
 * rather than shared: two builds, no common module — and the paths are a fixed drawing
