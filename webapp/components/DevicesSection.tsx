...
export function DevicesSection() {
  ...
  return (
    <Section title="Devices" description="Machines where you've signed in to the desktop app.">
      {installs === null ? (
        <p className="text-sm text-muted">Loading…</p>
      ) : installs.length === 0 ? (
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-muted">No device yet. Download the app and sign in to see it here.</p>
