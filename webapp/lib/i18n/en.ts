...
export const en = {
  ...
  'repo.tracker.modeHelp': 'Which trackers this repository uses',
  'repo.tracker.modeGithub': 'GitHub only',
  'repo.tracker.modeJira': 'Jira + GitHub',
  'repo.tracker.planTarget': 'New tickets go to',
  'repo.tracker.planTargetHelp': 'Where /magic:plan files the epic and its stories',
  'repo.tracker.planTargetJira': 'Jira',
  'repo.tracker.planTargetAsk': 'Ask each time',
