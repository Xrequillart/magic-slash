...
export const en = {
  ...
  'repo.tracker.githubTargetHelp': 'Derived from the repository remote. Only set an override in the config when the issues live in another repository',
  ...
  'repo.plan.trackerJira': 'Jira tickets',
  ...
  'repo.plan.trackerAsk': 'Ask each time',
