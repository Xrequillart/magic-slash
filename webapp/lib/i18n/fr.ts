...
export const fr: Record<keyof typeof en, string> = {
  ...
  'repo.tab.general': 'General',
  'repo.tab.languages': 'Languages',
  'repo.tab.git': 'Git',
  'repo.tracker.mode': 'Outils de suivi',
  'repo.tracker.modeHelp': 'Les outils de suivi utilisés par ce repository',
  'repo.tracker.modeGithub': 'GitHub uniquement',
  'repo.tracker.modeJira': 'Jira + GitHub',
  'repo.tracker.planTarget': 'Les nouveaux tickets vont dans',
  'repo.tracker.planTargetHelp': 'Où /magic:plan crée l’epic et ses stories',
  'repo.tracker.planTargetJira': 'Jira',
  'repo.tracker.planTargetAsk': 'Demander à chaque fois',
